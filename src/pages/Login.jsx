...
export default function Login({ onLogin }) {
  ...
  function handleGuru(e) {
    e.preventDefault()
    setRalat('')
    if (!nama.trim()) { setRalat('Sila masukkan nama anda.'); return }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4"
      ...
      <div className="fixed bottom-0 right-0 w-96 h-96 rounded-full opacity-10"
        style={{ background: 'radial-gradient(circle, #fbbf24, transparent)', transform: 'translate(30%, 30%)' }} />
      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="px-8 pt-8 pb-6 text-center"
            ...
            <p className="text-red-200 text-xs mt-1">文林望中华学校</p>
            ...
            {mod === 'guru' && (
              <form onSubmit={handleGuru} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="text" autoFocus required value={nama} onChange={e => setNama(e.target.value)}
            ...
            {mod === 'admin' && (
              <form onSubmit={handleAdmin} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="password" autoFocus required value={kataLaluan} onChange={e => setKataLaluan(e.target.value)}
                    placeholder="••••••••"
